...
import Layout from "lucide-react/dist/esm/icons/layout.mjs";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center px-4 sm:px-16">
          ...
          >
            ...
            <h3 className="text-lg text-neon-cyan font-mono mb-5 font-bold border-b border-neon-cyan/30 pb-2 inline-block">
              System Log
            </h3>
            ...
            <div className="space-y-6 mb-6">
              ...
              <div className="flex items-end justify-start gap-3">
                {/* Pixel Avatar SVG */}
                <div className="w-12 h-12 shrink-0 drop-shadow-[2px_2px_0_rgba(0,0,0,1)]">
                  <svg
                    viewBox="0 0 16 16"
                ...
                <div className="relative w-full sm:max-w-[75%]">
                  ...
                  <div className="relative bg-[#7e22ce] border-[3px] border-[#581c87] p-2.5 text-white font-mono text-sm font-bold">
                    Hello
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full sm:max-w-[95%]">
                {/* Dotted shadow */}
                <div className="absolute inset-0 translate-x-3 translate-y-3 bg-[radial-gradient(#a855f7_1px,transparent_1px)] bg-size-[3px_3px]"></div>

                <div className="relative bg-[#fdf2f8] border-[3px] border-[#fbcfe8] p-4 font-mono text-black">
                  <p className="font-bold mb-3 text-base">
                    Here is my profile:
                  </p>
                  <p className="text-sm mb-3 leading-relaxed font-medium">
                    I plan to architect resilient microservices and craft highly
                    scalable front-end interfaces for your upcoming projects.
                  </p>
                  <p className="text-sm mb-4 leading-relaxed font-medium">
                    When not coding, I explore generative AI and upgrade custom
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              <div className="flex flex-1 min-w-[6rem] max-w-[8rem] flex-col items-center justify-center p-3 bg-black/30 border border-neon-magenta/30 rounded box-glow-magenta">
                <span className="font-['Press_Start_2P'] text-neon-magenta text-lg mb-2">
                  4+
                </span>
                <span className="font-mono text-xs text-center text-gray-300">
                  Years Exp
                </span>
              </div>
              <div className="flex flex-1 min-w-[6rem] max-w-[8rem] flex-col items-center justify-center p-3 bg-black/30 border border-neon-yellow/30 rounded shadow-[0_0_15px_rgba(255,213,0,0.2)]">
                <span className="font-['Press_Start_2P'] text-neon-yellow text-lg mb-2">
                  10+
                </span>
                <span className="font-mono text-xs text-center text-gray-300">
                  Projects
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-lg text-neon-magenta font-mono mb-5 font-bold border-b border-neon-magenta/30 pb-2 inline-block">
              Core Capabilities
            </h3>

            <div className="relative overflow-hidden w-full py-3 flex flex-col gap-y-4">
              {/* Left Gradient Shadow */}
              <div className="absolute left-0 top-0 bottom-0 w-20 bg-linear-to-r from-cyber-purple to-transparent z-10 pointer-events-none"></div>
                    ...
                    <React.Fragment key={`row1-${skill.name}-${index}`}>
                      <motion.div
                        ...
                        className={`px-3 py-2 ${bgColor} text-black font-mono font-bold text-sm md:text-base 
                                   ...
                                   transition-all cursor-crosshair flex items-center gap-2 uppercase tracking-tight whitespace-nowrap shrink-0`}
                      >
                        <skill.icon
                          size={18}
                      ...
                      <Star
                        size={20}
                        className="text-transparent stroke-[#b026ff] stroke-[2.5] drop-shadow-[0_0_8px_rgba(176,38,255,0.9)] shrink-0"
                      />
                    </React.Fragment>
                  );
                })}
                ...
                {[...row2Skills, ...row2Skills].map((skill, index) => {
                  ...
                  return (
                    <React.Fragment key={`row2-${skill.name}-${index}`}>
                      ...
                      <Star
                        size={20}
                        className="text-transparent stroke-neon-cyan stroke-[2.5] drop-shadow-[0_0_8px_rgba(0,245,255,0.9)] shrink-0"
                      />
                    </React.Fragment>
                  );
                })}
              ...
              <div className="absolute right-0 top-0 bottom-0 w-20 bg-linear-to-l from-cyber-purple to-transparent z-10 pointer-events-none"></div>
            </div>
          </motion.div>
        </div>
      </div>
